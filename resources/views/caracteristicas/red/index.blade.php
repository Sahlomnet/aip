                ...
                <tbody>
                    @foreach ($networks as $network)
                        <tr>
                            ...
                            <td  class="text-center list-link"><a href="{{route('red.show', $network->id)}}">{{ $network->asset->obs ?? ''}}</a></td>
                            ...
                            <!-- <td  class="text-center list-link"><a href="{{route('red.show', $network->id)}}">{{ $network->created_at}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('red.show', $network->id)}}">{{ $network->updated_at}}</a></td> -->
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
