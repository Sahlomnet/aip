                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="expiration_date" data-target-input="nearest">
                                <input type="text" name="expiration_date" class="form-control datetimepicker-input" placeholder="Vigencia" data-target="#expiration_date" value="{{old('expiration_date')}}">
