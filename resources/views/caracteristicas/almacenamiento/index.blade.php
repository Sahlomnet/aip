                ...
                <tbody>
                    @foreach ($storages as $storage)
                        <tr>
                            ...
                            <td  class="text-center list-link"><a href="{{route('almacenamiento.show', $storage->id)}}">{{ $storage->asset->obs ?? ''}}</a></td>
                            ...
                            <!-- <td  class="text-center list-link"><a href="{{route('almacenamiento.show', $storage->id)}}">{{ $storage->created_at}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('almacenamiento.show', $storage->id)}}">{{ $storage->updated_at}}</a></td> -->
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
