                ...
                <tbody>
                    @foreach ($environments as $environment)
                        <tr>
                            ...
                            <td  class="text-center list-link"><a href="{{route('entorno.show', $environment->id)}}">{{ $environment->asset->des ?? ''}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('entorno.show', $environment->id)}}">{{ $environment->obs}}</a></td>
                            <!-- <td  class="text-center list-link"><a href="{{route('entorno.show', $environment->id)}}">{{ $environment->created_at}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('entorno.show', $environment->id)}}">{{ $environment->updated_at}}</a></td> -->
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
