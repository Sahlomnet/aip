                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Nombre</label>
                            <input type="text" name="name" class="form-control" placeholder="Nombre ..." value="{{old('des')}}">
                            @error('name')
                    ...
                    <div class="col md 6">
                        <div class="form-group">
                            ...
                            <input type="text" name="domain_group" class="form-control" placeholder="Grupo ó Dominio ..." value="{{old('des')}}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Usuario</label>
                            <input type="text" name="user" class="form-control" placeholder="Usuario ..." value="{{old('des')}}">
                            @error('user')
                                <small class="text-danger">*{{$message}}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input type="password" class="form-control" name="password" autocomplete="current-password" id="id_password" value="{{old('des')}}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="rdp_port" class="form-control" placeholder="Puerto RDP ...">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
