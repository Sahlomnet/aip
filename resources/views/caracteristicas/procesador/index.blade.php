                ...
                <tbody>
                    @foreach ($processors as $processor)
                        <tr>
                            ...
                            <td  class="text-center list-link"><a href="{{route('procesador.show', $processor->id)}}">{{ $processor->asset->des ?? ''}}</a></td>
                            ...
                            <!-- <td  class="text-center list-link"><a href="{{route('procesador.show', $processor->id)}}">{{ $processor->created_at}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('procesador.show', $processor->id)}}">{{ $processor->updated_at}}</a></td> -->
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
