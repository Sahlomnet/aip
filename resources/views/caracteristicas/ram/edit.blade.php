...
@section('title', 'RAM - Edit')

@section('content_header')
    <h1>Editar RAM {{$ram->id}}</h1>
@stop
...
@section('content')
    ...
    <div class="card">
        ...
        <form action="{{route('ram.update', $ram)}}" method="POST">
            @csrf
            @method('put')
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="interface" class="form-control" value="{{$ram->interface}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Velocidad</label>
                            <input type="text" name="speed" class="form-control" value="{{$ram->speed}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Capacidad</label>
                            <input type="text" name="capacity" class="form-control" value="{{$ram->capacity}}">
                            @error('capacity')
                ...
                <div class="form-group">
                    ...
                    <textarea name="obs" class="form-control" rows="5">{{$ram->obs}}</textarea>
                </div>
            </div>
