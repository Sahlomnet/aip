                ...
                <tbody>
                    @foreach ($rams as $ram)
                        <tr>
                            ...
                            <td  class="text-center list-link"><a href="{{route('ram.show', $ram->id)}}">{{ $ram->asset->des ?? ''}}</a></td>
                            ...
                            <!-- <td  class="text-center list-link"><a href="{{route('ram.show', $ram->id)}}">{{ $ram->created_at}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('ram.show', $ram->id)}}">{{ $ram->updated_at}}</a></td> -->
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
