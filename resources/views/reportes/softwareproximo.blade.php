...
@section('title', 'Software Próximo')

@section('content_header')
    <h1>Licencias de Software próximas a vencer</h1>
@stop
                ...
                <tbody>
                    @foreach ($licenses as $license)
                        <tr>
                            ...
                            <td  class="text-center list-link"><a href="{{route('software.show', $license->id)}}">{{ $license->asset->obs ?? ''}}</a></td>
                            ...
                            <!-- <td  class="text-center list-link"><a href="{{route('software.show', $license->id)}}">{{ $license->created_at}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('software.show', $license->id)}}">{{ $license->updated_at}}</a></td> -->
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
