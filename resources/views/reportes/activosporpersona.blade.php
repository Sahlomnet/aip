                ...
                <tbody>
                    @foreach ($people as $person)
                        <tr>
                            ...
                            <td  class="text-center list-link"><a href="{{route('personas.show', $person->id)}}">{{ $person->name }} {{ $person->last_name }}</a></td>
                            ...
                            <!-- <td  class="text-center list-link"><a href="{{route('personas.show', $person->id)}}">{{ $person->location->name ?? '' }}</a></td> -->
                            <!-- <td  class="text-center list-link"><a href="{{route('personas.show', $person->id)}}">{{ $person->placement->name ?? '' }}</a></td> -->
                            <!-- <td  class="text-center list-link"><a href="{{route('personas.show', $person->id)}}">{{ $person->obs }}</a></td> -->
                            <!-- <td  class="text-center list-link"><a href="{{route('personas.show', $person->id)}}">{{ $person->created_at }}</a></td>
                            <td  class="text-center list-link"><a href="{{route('personas.show', $person->id)}}">{{ $person->updated_at }}</a></td> -->
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
