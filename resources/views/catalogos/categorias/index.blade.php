            ...
            <table id="table01" class="table table-striped table-bordered shadow-lg mt-4" style="width:100%">
                ...
                <tbody>
                    @foreach ($categories as $category)
                        <tr>
                            <td  class="text-center list-link"><a href="{{route('categorias.show', $category->id)}}">{{ $category->id}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('categorias.show', $category->id)}}">{{ $category->cod}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('categorias.show', $category->id)}}">{{ $category->des}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('categorias.show', $category->id)}}">{{ $category->obs}}</a></td>
                            <!-- <td  class="text-center list-link"><a href="{{route('categorias.show', $category->id)}}">{{ $category->created_at}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('categorias.show', $category->id)}}">{{ $category->updated_at}}</a></td> -->
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
