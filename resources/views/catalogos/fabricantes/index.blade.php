            ...
            <table id="table01" class="table table-striped table-bordered shadow-lg mt-4" style="width:100%">
                ...
                <tbody>
                    @foreach ($manufacturers as $manufacturer)
                        <tr>
                            <td  class="text-center list-link"><a href="{{route('fabricantes.show', $manufacturer->id)}}">{{ $manufacturer->id}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('fabricantes.show', $manufacturer->id)}}">{{ $manufacturer->des}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('fabricantes.show', $manufacturer->id)}}">{{ $manufacturer->obs}}</a></td>
                            <!-- <td  class="text-center list-link"><a href="{{route('fabricantes.show', $manufacturer->id)}}">{{ $manufacturer->created_at}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('fabricantes.show', $manufacturer->id)}}">{{ $manufacturer->updated_at}}</a></td> -->
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
