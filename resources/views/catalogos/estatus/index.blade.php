            ...
            <table id="table01" class="table table-striped table-bordered shadow-lg mt-4" style="width:100%">
                ...
                <tbody>
                    @foreach ($statuses as $status)
                        <tr>
                            <td  class="text-center list-link"><a href="{{route('estatus.show', $status->id)}}">{{ $status->id}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('estatus.show', $status->id)}}">{{ $status->des}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('estatus.show', $status->id)}}">{{ $status->obs}}</a></td>
                            <!-- <td  class="text-center list-link"><a href="{{route('estatus.show', $status->id)}}">{{ $status->created_at}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('estatus.show', $status->id)}}">{{ $status->updated_at}}</a></td> -->
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
