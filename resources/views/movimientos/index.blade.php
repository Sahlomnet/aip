            ...
            <table id="table01" class="table table-striped table-bordered shadow-lg mt-4" style="width:100%">
                <thead class="bg-secondary text-white">
                    <tr>
                        ...
                        <!-- <th class="text-center">Des Asignación</th>
                ...
                <tbody>
                    @foreach ($movements as $movement)
                        <tr>
                            ...
                            <!-- <td  class="text-center list-link"><a href="{{route('movimientos.show', $movement->id)}}">{{ $movement->deallocation_date}}</a></td> -->
                            <!-- <td  class="text-center list-link"><a href="{{route('movimientos.show', $movement->id)}}">{{ $movement->allocation_status}}</a></td> -->
                            <!-- <td  class="text-center list-link"><a href="{{route('movimientos.show', $movement->id)}}">{{ $movement->location_id}}</a></td> -->
                            <td  class="text-center list-link"><a href="{{route('movimientos.show', $movement->id)}}">{{ $movement->placement->name}}</a></td>
                            <!-- <td  class="text-center list-link"><a href="{{route('movimientos.show', $movement->id)}}">{{ $movement->people_id}}</a></td> -->
                            ...
                            <!-- <td  class="text-center list-link"><a href="{{route('movimientos.show', $movement->id)}}">{{ $movement->created_at}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('movimientos.show', $movement->id)}}">{{ $movement->updated_at}}</a></td> -->
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
