...
@section('title', 'Locación - Edit')

@section('content_header')
    <h1>Editar Locación {{$location->id}}</h1>
@stop
...
@section('content')
    ...
    <div class="card">
        ...
        <form action="{{route('locaciones.update', $location)}}" method="POST">
            @csrf
            @method('put')
            <div class="card-body">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="public_ip" class="form-control" value="{{$location->public_ip}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>DNS Público</label>
                            <input type="text" name="public_dns" class="form-control" value="{{$location->public_dns}}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Calle</label>
                            <input type="text" name="street" class="form-control" value="{{$location->street}}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Número exterior</label>
                            <input type="text" name="ext_number" class="form-control" value="{{$location->ext_number}}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Número interior</label>
                            <input type="text" name="int_number" class="form-control" value="{{$location->int_number}}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Colonia</label>
                            <input type="text" name="col" class="form-control" value="{{$location->col}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="mun" class="form-control" value="{{$location->mun}}">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="form-group">
                    ...
                    <textarea name="obs" class="form-control" rows="5">{{$location->obs}}</textarea>
                </div>
            </div>
