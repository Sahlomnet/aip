                ...
                <tbody>
                    @foreach ($addresses as $address)
                        <tr>
                            ...
                            <td  class="text-center list-link"><a href="{{route('direcciones.show', $address->id)}}">{{ $address->name}}</a></td>
                            ...
                            <td  class="text-center list-link"><a href="{{route('direcciones.show', $address->id)}}">{{ $address->obs}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('direcciones.show', $address->id)}}">{{ $address->created_at}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('direcciones.show', $address->id)}}">{{ $address->updated_at}}</a></td>
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
