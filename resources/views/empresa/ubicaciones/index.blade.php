                ...
                <tbody>
                    @foreach ($placements as $placement)
                        <tr>
                            ...
                            <!-- <td  class="text-center list-link"><a href="{{route('ubicaciones.show', $placement->id)}}">{{ $placement->created_at }}</a></td> -->
                            <!-- <td  class="text-center list-link"><a href="{{route('ubicaciones.show', $placement->id)}}">{{ $placement->updated_at }}</a></td> -->
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
