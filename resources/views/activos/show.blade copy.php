    ...
    <div class="card card-solid">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12 col-sm-6">
                    <h3 class="my-3">Código: {{$asset->cod}}</h3>
                    <p>Descripción: {{$asset->des}}</p>
                    <p>Modelo: {{$asset->model}}</p>
                    <p>Serie: {{$asset->serial}}</p>
                    <hr>
                    <p>Fecha de Compra: {{$asset->purchase_date}}</p>
                    <p>Factura: {{$asset->invoice}}</p>
                    <p>Costo: {{$asset->cost}}</p>
                    <hr>
    ...
    <div class="card">
        ...
        <form>
            <div class="card-body">
                ...
                <div class="form-group">
                    <label>Código</label>
                    <input type="text" class="form-control" value="{{$asset->cod}}" disabled>
                </div>
                <div class="form-group">
                    <label>Descripción</label>
                    <input type="text" class="form-control" value="{{$asset->des}}" disabled>
                </div>
                <div class="form-group">
                    <label>Modelo</label>
                    <input type="text" class="form-control" value="{{$asset->model}}" disabled>
                </div>
                <div class="form-group">
                    <label>Serie</label>
                    <input type="text" class="form-control" value="{{$asset->serial}}" disabled>
                </div>
                <div class="form-group">
                    <label>Imágen</label>
                    <input type="text" class="form-control" value="{{$asset->img}}" disabled>
                </div>
                <div class="form-group">
                    <label>Costo</label>
                    <input type="text" class="form-control" value="{{$asset->cost}}" disabled>
                </div>
                <div class="form-group">
                    <label>Fecha de Compra</label>
                    <input type="text" class="form-control" value="{{$asset->purchase_date}}" disabled>
                </div>
                <div class="form-group">
                    <label>Factura</label>
                    <input type="text" class="form-control" value="{{$asset->invoice}}" disabled>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$asset->placement->name ?? ''}}" disabled>
                </div>
                <div class="form-group">
                    <label>Persona (Usuario)</label>
                    <input type="text" class="form-control" value="{{$asset->people->name ?? ''}}" disabled>
                </div>
                <div class="form-group">
                    <label>Categoría</label>
                    <input type="text" class="form-control" value="{{$asset->category->des ?? ''}}" disabled>
                </div>
                <div class="form-group">
                    <label>Fabricante</label>
                    <input type="text" class="form-control" value="{{$asset->manufacturer->des ?? ''}}" disabled>
                </div>
                <div class="form-group">
                    <label>Estatus</label>
                    <input type="text" class="form-control" value="{{$asset->status->des ?? ''}}" disabled>
                </div>
                <div class="form-group">
                    <label>Uso</label>
                    <input type="text" class="form-control" value="{{$asset->usage->des ?? ''}}" disabled>
                </div>
                <div class="form-group">
                    <label>Observaciones</label>
                    <textarea name="obs" class="form-control" rows="5" disabled>{{$asset->obs}}</textarea>
                </div>
                <div class="form-group">
                    <label>Fecha de Creación</label>
                    <input type="text" class="form-control" value="{{$asset->created_at}}" disabled>
                </div>
                <div class="form-group">
                    <label>Fecha de Actualización</label>
                    <input type="text" class="form-control" value="{{$asset->updated_at}}" disabled>
                </div>
            </div>
